<?php 
    ...
    $sql3 = "SELECT * FROM subhabilidades ORDER BY nome DESC";
    $query3 = mysqli_query($mysqli, $sql3);
    $contar_query3 = mysqli_num_rows($query3);

    $sql6 = "SELECT * FROM habilidades ORDER BY nome ASC";
    $query6 = mysqli_query($mysqli, $sql6);

    if (isset($_GET['deletar'])) {
    	

    	$sql5 = "DELETE FROM  subhabilidades WHERE id = '".$_GET['id']."' ";
    	$query5 = mysqli_query($mysqli, $sql5);

    	header("Location: subcategorias?deleted");

    }

    if (isset($_POST['editar'])) {

    	$sql5 = "UPDATE subhabilidades SET nome = '".$_POST['nome']."', id_habilidades = '".$_POST['id_habilidades']."' WHERE id = '".$_POST['id']."'";
    	$query5 = mysqli_query($mysqli, $sql5);

    	header("Location: subcategorias?edited");

    }

    if (isset($_POST['novo'])) {
    	
    	$sql5 = "INSERT INTO subhabilidades (nome, id_habilidades) VALUES ('".$_POST['nome']."','".$_POST['id_habilidades']."')";
    	$query5 = mysqli_query($mysqli, $sql5);

    	header("Location: subcategorias?success");
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary white">
                                    <h4 class="modal-title" id="myModalLabel11" style="font-size: 12px; color: white;">Crie subcategorias para Geets.</h4>
                                        		...
                                        		<div class="form-group">
                                                    <div class="form-line">
                                                    	Selecione uma categoria
                                                         <select class="form-control" name="id_habilidades" required="">
                                                         	<option>...</option>
                                                         	<?php  while($dados6 = mysqli_fetch_array($query6)){ ?>
                                                         		<option value="<?php  echo $dados6['id']; ?>"><?php  echo $dados6['nome']; ?></option>
                                                         	<?php  } ?>
                                                         </select>
                                                    </div>
                                                </div>
                                        		...
                                        		<div class="form-group">
                                                    <div class="form-line">
                                                    	Nome da subcategoria
                                                         <input required="" value="" type="text" placeholder="Digite um nome Ex: Redator" class="form-control"  name="nome">
                                                    </div>
                                                </div>
                                            </div>
					...
					<div class="db-table table-responsive" style="padding: 20px;">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <?php  while($dados3 = mysqli_fetch_array($query3)){  
                            	...
                            	$sql4 = "SELECT * FROM habilidades WHERE id = '".$dados3['id_habilidades']."'";
                                ...
                                <tr>
                                    ...
                                    <div class="modal fade text-left" id="editar<?php  echo $dados3['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
				                        <div class="modal-dialog modal-lg" role="document">
				                            <div class="modal-content">
				                                <div class="modal-header bg-primary white">
				                                    <h4 class="modal-title" id="myModalLabel11" style="font-size: 12px; color: white;">Editar subcategorias para Geets.</h4>
				                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				                                        <span aria-hidden="true">&times;</span>
				                                    </button>
				                                </div>
				                                ...
				                                <form method="POST" action="">
				                                    ...
				                                    <div class="modal-body">
				                                        ...
				                                        <div class="row container" style="font-size: 14px;">
				                                        	...
				                                        	<?php 
				                                        		$sql7 = "SELECT * FROM habilidades ORDER BY nome ASC";
   															 	$query7 = mysqli_query($mysqli, $sql7);

   															 	$sql70 = "SELECT * FROM habilidades WHERE id = '".$dados3['id_habilidades']."'";
   															 	$query70 = mysqli_query($mysqli, $sql70);
   															 	$dados70 = mysqli_fetch_assoc($query70);
				                                        	?>
				                                        	...
				                                        	<div class="col-sm-12" style="margin-bottom: 15px;">
				                                        		<div class="form-group">
				                                                    <div class="form-line">
				                                                    	Selecione uma categoria
				                                                         <select class="form-control" name="id_habilidades" required="">
				                                                         	<option value="<?php  echo $dados3['id_habilidades']; ?>"><?php  echo $dados70['nome']; ?></option>
				                                                         	<?php  while($dados7 = mysqli_fetch_array($query7)){ ?>
				                                                         		<option value="<?php  echo $dados7['id']; ?>"><?php  echo $dados7['nome']; ?></option>
				                                                         	<?php  } ?>
				                                                         </select>
				                                                    </div>
				                                                </div>
				                                            ...
				                                            <div class="col-sm-12">
				                                        		<div class="form-group">
				                                                    <div class="form-line">
				                                                    	Nome da categoria
				                                                         <input value="<?php  echo $dados3['nome']; ?>" type="text" placeholder="Digite um nome Ex: Copywriting" class="form-control"  name="nome">
				                                                    </div>
				                                                </div>
				                                            </div>
