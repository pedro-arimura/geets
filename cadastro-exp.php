...
if($verify < 1){
    if(isset($_POST['cadastrar'])){
        ...
        $insertUsuario = $mysqli->query("INSERT INTO usuarios VALUES (DEFAULT,'".$mysqli->real_escape_string($_POST[nome])."','".$mysqli->real_escape_string($_POST[email])."','".$mysqli->real_escape_string($_POST[senha])."','2', '2','".date('Y-m-d')."','".date('H:i:s')."', '', '".$mysqli->real_escape_string($_POST[especialidade])."')");
        ...
        if($_FILES['imgPerfil']['name'] != ""){
            ...
            $insertPerfil = $mysqli->query("INSERT INTO perfil_expert VALUES(DEFAULT, '$getId[id]', '".$mysqli->real_escape_string($_POST[nome])."', '".$mysqli->real_escape_string($_POST[especialidade])."', '$capa', '".$mysqli->real_escape_string($_POST[desc])."', '".$mysqli->real_escape_string($_POST[diferencial])."', '".$mysqli->real_escape_string($_POST[estagio])."', '".$mysqli->real_escape_string($_POST[lancamento])."', '".$mysqli->real_escape_string($_POST[facebook])."', '".$mysqli->real_escape_string($_POST[instagram])."', '".$mysqli->real_escape_string($_POST[youtube])."')");
            $updateImagem = $mysqli->query("UPDATE usuarios SET thumb = '$capa' WHERE id = ".$getId['id']."");
        }
        else{
            $insertPerfil = $mysqli->query("INSERT INTO perfil_expert VALUES(DEFAULT, '$getId[id]', '".$mysqli->real_escape_string($_POST[nome])."', '".$mysqli->real_escape_string($_POST[especialidade])."', '', '".$mysqli->real_escape_string($_POST[desc])."', '".$mysqli->real_escape_string($_POST[diferencial])."', '".$mysqli->real_escape_string($_POST[estagio])."', '".$mysqli->real_escape_string($_POST[lancamento])."', '".$mysqli->real_escape_string($_POST[facebook])."', '".$mysqli->real_escape_string($_POST[instagram])."', '".$mysqli->real_escape_string($_POST[youtube])."')");
        }
        ...
        if ($_SESSION['usuarioNiveisAcessoId'] == 2) {
          header("Location: profile-exp.php?id=".$getId['id']."");
...
<body>
    ...
    <section class="mx-auto mt-5 tab"> <!-- First Section -->
        ...
        <section class="mx-auto mt-5 tab">
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center">
                    <p class="h1 tsize-2 pt-5"> Qual a sua especialidade? </p>
                    <small id="help" class="form-text text-muted mb-5"> Ex: Nicho ou subnicho. </small>
                        <div class="form-group w-75 mx-auto">
                            <input type="text" class="form-control input-small" id="especialidade" name="especialidade">
        ...
        <section class="mx-auto mt-5 tab">
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center w-75">
                    <p class="h1 mb-4 tsize-2 pt-5"> Fale sobre sua especialidade e o diferencial do seu trabalho! </p>
                        <div class="form-group w-100 mx-auto">
                            <textarea class="form-control input-big" id="diferencial" name="diferencial"> </textarea>
                        </div>
                        <button type="button" class="btn w-100 mt-2" onclick="nextPrev(1);"> Prosseguir </button>
                        <button type="button" class="btn-back w-100 mt-3 mb-5" onclick="nextPrev(1)">  Pular <i class="fas fa-arrow-right"></i></button>
                </div>
        ...
        <section class="mx-auto mt-5 tab">
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center w-75">
                    <p class="h1 mb-4 tsize-2 pt-5"> Conte em qual estágio você está, se está iniciando agora ou se já possui alguma audiência. 
                    Se sim, qual o tamanho? </p>
                        <div class="form-group w-100 mx-auto">
                            <textarea class="form-control input-big" id="estagio" name="estagio"> </textarea>
                        </div>
                        <button type="button" class="btn w-100 mt-2" onclick="nextPrev(1);"> Prosseguir </button>
                        <button type="button" class="btn-back w-100 mt-3 mb-5" onclick="nextPrev(1)">  Pular <i class="fas fa-arrow-right"></i></button>
                </div>
        ...
        <section class="mx-auto mt-5 tab">
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center w-75">
                    <p class="h1 mb-4 tsize-2 pt-5"> Você já fez algum lançamento? Possui algum infoproduto? </p>
                        <div class="form-group w-100 mx-auto">
                            <textarea class="form-control input-big" id="lancamento" name="lancamento"> </textarea>
                        </div>
                        <button type="button" class="btn w-100 mt-2" onclick="nextPrev(1);"> Prosseguir </button>
                        <button type="button" class="btn-back w-100 mt-3 mb-5" onclick="nextPrev(1)">  Pular <i class="fas fa-arrow-right"></i></button>
                </div>
