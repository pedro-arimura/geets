<?php 
    ...
    $sql3 = "SELECT * FROM projetos ORDER BY id DESC";
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <?php  while($dados3 = mysqli_fetch_array($query3)){ ?>
                                <tr>
                                    ...
                                    <td><?php  echo $dados3['habilidades']; ?></td>
                                    ...
                                    <td>
                                    	<div class="btn-group">
										  ...
										  <div class="dropdown-menu">
										    <a class="dropdown-item" href="?del&id=<?php  echo $dados3['id']; ?>">Deletar</a>
										    <a target="_blank" class="dropdown-item" href="detalhe-projeto?id=<?php  echo $dados3['id']; ?>">Ver Projeto</a>
										  </div>
										</div>
                                    </td>
