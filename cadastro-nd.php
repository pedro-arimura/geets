<?php
    ...
    if($verify < 1){
        if(isset($_POST['cadastrar'])){
            $insertUsuario = $mysqli->query("INSERT INTO usuarios VALUES (DEFAULT,'$_POST[nome]','$_POST[email]','$_POST[senha]','1', '1','".date('Y-m-d')."','".date('H:i:s')."', '', '".$mysqli->real_escape_string($_POST[modelo])."')");
            ...
            if($_FILES['imgPerfil']['name'] != ""){
                ...
                $capa = "1".$m.$capa['name'];
                $insertPerfil = $mysqli->query("INSERT INTO perfil_negocio_digital VALUES(DEFAULT, '$getId[id]', '".$mysqli->real_escape_string($_POST[nome])."', '".$mysqli->real_escape_string($_POST[modelo])."', '$capa', '".$mysqli->real_escape_string($_POST[sede])."', '".$mysqli->real_escape_string($_POST[desc])."', '".$mysqli->real_escape_string($_POST[atuacao])."', '".$mysqli->real_escape_string($_POST[pilaresnegocio])."', '".$mysqli->real_escape_string($_POST[diferenciais])."', '$_POST[idade]', '$_POST[movimentacao]', '$_POST[facebook]', '$_POST[instagram]', '$_POST[youtube]')");
                $updateImagem = $mysqli->query("UPDATE usuarios SET thumb = '$capa' WHERE id = ".$getId['id']."");
            }
            else{
                $insertPerfil = $mysqli->query("INSERT INTO perfil_negocio_digital VALUES(DEFAULT, '$getId[id]', '".$mysqli->real_escape_string($_POST[nome])."', '".$mysqli->real_escape_string($_POST[modelo])."', '', '".$mysqli->real_escape_string($_POST[sede])."', '".$mysqli->real_escape_string($_POST[desc])."', '".$mysqli->real_escape_string($_POST[atuacao])."', '".$mysqli->real_escape_string($_POST[pilaresnegocio])."', '".$mysqli->real_escape_string($_POST[diferenciais])."', '$_POST[idade]', '$_POST[movimentacao]', '$_POST[facebook]', '$_POST[instagram]', '$_POST[youtube]')");
            }
                ...
                <div class="content-register mx-auto text-center"> <!-- Div for content-center -->
                    ...
                    <small id="help" class="form-text text-muted mb-5"> Ex: Agência de lançamentos, coprodutor, etc. </small>
                        <div class="form-group w-75 mx-auto"> <!-- Div input -->
                            <input type="text" class="form-control input-small" id="modelo" name="modelo">
                            <span class="error-alert" id="erro-1">* Preencha o modelo do seu negócio!</span>
                        </div>
                        <button type="button" class="btn w-75 mt-2 mb-3" id="nextBtn" onclick="nextPrev(1)"> Prosseguir </button>
                </div>
            </div>
        </section>
            ...
            <div class="form-register mx-auto position-relative mb-5">
                <div class="content-register mx-auto text-center">
                    ...
                    <small id="help" class="form-text text-muted mb-5"> Clique no ícone para adicionar sua imagem. </small>
                        ...
                        <button type="button" class="btn w-75 mt-3 mb-5" onclick="nextPrev(1)"> Prosseguir </button>
                </div>
            </div>
        </section>
                ...
                <div class="content-register mx-auto text-center w-75">
                    <p class="h1 mb-5 tsize-2 pt-5"> Onde fica a sede da empresa? </p>
                        <div class="form-group w-100 mx-auto mb-5">
                            <input class="form-control input-small" list="sedes" name="sede" id="sede">
                        </div>
            ...
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center w-75">
                    <p class="h1 mb-5 tsize-2 pt-5"> Fale sobre os projetos que atua e se tem preferência por algum nicho. </p>
                        <div class="form-group w-100 mx-auto">
                            <textarea class="form-control input-big" id="atuacao" name="atuacao"> </textarea>
                        </div>
                        <button type="button" class="btn w-100 mt-2" id="nextBtn" onclick="nextPrev(1)"> Prosseguir </button>
                        <button type="button" class="btn-back w-100 mt-3 mb-5" onclick="nextPrev(1)">  Pular <i class="fas fa-arrow-right"></i></button>
                </div>
            ...
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center w-75">
                    ...
                    <small id="help" class="form-text text-muted mb-5"> Ex: Lançamento, produção de infoproduto, etc. </small>
                        <div class="form-group w-100 mx-auto">
                            <textarea class="form-control input-big" id="pilaresnegocio" name="pilaresnegocio"> </textarea>
                        </div>
                        <button type="button" class="btn w-100 mt-2" id="nextBtn" onclick="nextPrev(1)"> Prosseguir </button>
                        <button type="button" class="btn-back w-100 mt-3 mb-5" onclick="nextPrev(1)">  Pular <i class="fas fa-arrow-right"></i></button>
                </div>
            ...
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center w-75">
                    <p class="h1 mb-4 tsize-2 pt-5"> Quais os diferenciais do seu negócio e os principais resultados gerados? </p>
                        <div class="form-group w-100 mx-auto">
                            <textarea class="form-control input-big" id="diferenciais" name="diferenciais"> </textarea>
                        </div>
                        <button type="button" class="btn w-100 mt-2" id="nextBtn" onclick="nextPrev(1)"> Prosseguir </button>
                        <button type="button" class="btn-back w-100 mt-3 mb-5" onclick="nextPrev(1)">  Pular <i class="fas fa-arrow-right"></i></button>
                </div>
            ...
            <div class="form-register mx-auto position-relative">
                <div class="content-register mx-auto text-center w-75">
                    <p class="h1 mb-5 tsize-2 pt-5"> Há quanto tempo está atuando no mercado? </p>
                        <div class="form-group w-100 mx-auto">
                            <select class="form-control form-control-lg" id="idade" name="idade">
