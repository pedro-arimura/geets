...
if (isset($_POST['save_descricao'])) {
    ...
    $sql2 = "UPDATE perfil_expert SET descricao = '".$_POST['descricao']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);

    header("Location: profile-exp.php?id=".$_POST['id']."&success");

}

if (isset($_POST['save_especialidade'])) {
        
    $sql2 = "UPDATE perfil_expert SET especialidade = '".$_POST['especialidade']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
	$mysqli->query("UPDATE usuarios SET titulo = '".$_POST['especialidade']."' WHERE id = '".$_POST['id']."'");
    header("Location: profile-exp.php?id=".$_POST['id']."&success");
...
if (isset($_POST['save_contatos'])) {
    ...
    $sql2 = "UPDATE perfil_expert SET facebook = '".$_POST['facebook']."',instagram = '".$_POST['instagram']."',youtube = '".$_POST['youtube']."'  WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
if (isset($_POST['save_diferencial'])) {
        
    $sql2 = "UPDATE perfil_expert SET diferencial = '".$_POST['diferencial']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
if (isset($_POST['save_estagio'])) {
        
    $sql2 = "UPDATE perfil_expert SET estagio = '".$_POST['estagio']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
if (isset($_POST['save_lancamento'])) {
        
    $sql2 = "UPDATE perfil_expert SET lancamento = '".$_POST['lancamento']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
if (isset($_POST['save_fat-mercado'])) {
    ...
    $sql2 = "UPDATE perfil_expert SET tempo_atuacao = '".$_POST['tempo_atuacao']."', movimentacao = '".$_POST['movimentacao']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
if (isset($_POST['save_thumb'])) {
    ...
    $sql2 = "UPDATE perfil_expert SET thumb = '".$capa."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
if (isset($_POST['save_treinamento'])) {
    ...
    $sql2 = "UPDATE perfil_expert SET lancamento = '".$_POST['descricao']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
if (isset($_POST['save_treinamento'])) {
    ...
    $sql2 = "UPDATE perfil_expert SET treinamento = '".$_POST['descricao']."' WHERE id_usuario = '".$_POST['id']."'";
    $query2 =  mysqli_query($mysqli, $sql2);
...
<!-- header.php -->
	<section id="freelancer-portfolio" style="background: url(img/freelancer/freelancer-profile-bg.jpg);">
        <div class="container">
            ...
            <a data-toggle="modal" role="button" href="#especialidade" class="online" style="color: #afafaf; padding: 0px;"><i class="fas fa-share"></i> Editar</a>


            <div class="modal fade text-left" id="especialidade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
             <div class="modal-dialog modal-lg" role="document">
                 <div class="modal-content">
                     <div class="modal-header bg-primary white">
                     ...
                     <form method="POST" action="">
                         ...
                         <div class="modal-body">
                             ...
                             <div class="row container">
                                 ...
                                 <div class="col-sm-12">
                                     <div class="form-group">
                                         <div class="form-line">
                                              <textarea placeholder="Ex: Gestor de Tráfego" class="form-control" rows="5" name="especialidade"><?php  echo $dados11['especialidade']; ?></textarea>
                                         </div>
                                     </div>
                                 </div>
                         ...
                         <div class="modal-footer">
                             <button class="btn btn-outline-info" type="submit" value="salvar" name="save_especialidade">Salvar</button>
                             <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Fechar</button>
                         </div>
        ...
        <?php  } ?>
                               <h4 class="profile-title text-muted">
                                ...
                                <?php  if ($dados11['especialidade'] == '') {
                                    echo "Especialidade";
                                }else{
                                    echo $dados11['especialidade']; 
                                } ?> 
...
<!-- ================ NOVA SEÇÃO ======================= -->
        ...
        <div class="container mt-n5" style="margin-top: -9rem;">
            <div class="freelancer-portfolio"  style=" margin-bottom: 10rem">
               <div class="row">
                  	<div class="w-75 ml-5">
	                    <div class="freelancer-info">
							...
							<div class="space-between-items">				   
                                <?php  if ($dados1['id'] == $_SESSION['usuarioId'] OR $_SESSION['usuarioNiveisAcessoId'] == 3) { ?>
	                           		...
	                           		<br><a data-toggle="modal" role="button" href="#estagio" class="online" style="color: #afafaf; padding: 0px;"><i class="fas fa-share"></i> Editar</a>

	                           		<div class="modal fade text-left" id="estagio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary white">
                                                    <h4 class="modal-title" id="myModalLabel11" style="font-size: 12px; color: white;">Qual o tamanho da sua audiência?</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                ...
                                                <form method="POST" action="">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row container">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                         <textarea placeholder="Cidade Tal, Bairro Tal, Rua Tal, Número" class="form-control" rows="5" name="estagio"><?php  echo $dados11['estagio']; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-outline-info" type="submit" value="salvar" name="save_estagio">Salvar</button>
                                                        <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Fechar</button>
                                                    </div>
	                           ...
	                           <p><?php  if ($dados11['estagio'] == '') {
								   	echo('<h4 class="profile-title text-muted"> Audiência </h4>');
	                           		echo "Audiência";
	                           	}else{
									echo('<h4 class="profile-title text-muted"> Audiência </h4>');
	                           		echo($dados11['estagio']); 
	                           	} ?>  
	                           	</p>
							</div>
							...
							<div class="space-between-items">				   
                                <?php  if ($dados1['id'] == $_SESSION['usuarioId'] OR $_SESSION['usuarioNiveisAcessoId'] == 3) { ?>
	                           		...
	                           		<br><a data-toggle="modal" role="button" href="#diferencial" class="online" style="color: #afafaf; padding: 0px;"><i class="fas fa-share"></i> Editar</a>

	                           		<div class="modal fade text-left" id="diferencial" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary white">
                                                    <h4 class="modal-title" id="myModalLabel11" style="font-size: 12px; color: white;">Fale um pouco sobre seus diferenciais.</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                ...
                                                <form method="POST" action="">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row container">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                         <textarea class="form-control" rows="5" name="diferencial"><?php  echo $dados11['diferencial']; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-outline-info" type="submit" value="salvar" name="save_diferencial">Salvar</button>
                                                        <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Fechar</button>
                                                    </div>
	                           ...
	                           <p><?php  if ($dados11['diferencial'] == '') {
								   	echo('<h4 class="profile-title text-muted"> Diferencial </h4>');
	                           		echo "Diferencial";
	                           	}else{
									echo('<h4 class="profile-title text-muted"> Diferencial </h4>');
	                           		echo($dados11['diferencial']); 
	                           	} ?>  
							...
							<div class="space-between-items">				   
                                <?php  if ($dados1['id'] == $_SESSION['usuarioId'] OR $_SESSION['usuarioNiveisAcessoId'] == 3) { ?>
	                           		...
	                           		<br><a data-toggle="modal" role="button" href="#lancamento" class="online" style="color: #afafaf; padding: 0px;"><i class="fas fa-share"></i> Editar</a>

	                           		<div class="modal fade text-left" id="lancamento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary white">
                                                    <h4 class="modal-title" id="myModalLabel11" style="font-size: 12px; color: white;">Já possui algum infoproduto? Qual?</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                ...
                                                <form method="POST" action="">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row container">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                         <textarea class="form-control" rows="5" name="lancamento"><?php  echo $dados11['lancamento']; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-outline-info" type="submit" value="salvar" name="save_lancamento">Salvar</button>
                                                        <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Fechar</button>
                                                    </div>
	                           ...
	                           <p><?php  if ($dados11['lancamento'] == '') {
								   	echo('<h4 class="profile-title text-muted"> Infoprodutos </h4>');
	                           		echo "Infoprodutos";
	                           	}else{
									echo('<h4 class="profile-title text-muted"> Infoprodutos </h4>');
	                           		echo($dados11['lancamento']); 
	                           	} ?>  
	                           	</p>
							</div>
